              ...
              <tr>
                  ...
                  <td>
                      ...
                      {{-- <a class="btn btn-outline-success btn-sm details-demande" type="button" href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                        ...
                        <a class="btn btn-outline-success btn-sm details-demande" type="button" href=""><div style="size: 5px">Participer</div></a>
                  ...
                  <td>
                    ...
                    {{-- <a class="btn btn-outline-success btn-sm details-demande" type="button" href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                      ...
                      <a class="btn btn-outline-success btn-sm details-demande" type="button" href="">Detail</a>
